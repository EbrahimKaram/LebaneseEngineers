...
if __name__ == "__main__":
    ...
    for index, row in df.iterrows():
        ...
        displine.to_csv(
            "Data/" + str(field) + " " + str(subfield) + ".csv", index=False
        )
